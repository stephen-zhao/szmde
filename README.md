...
Current status, milestones, and what's next live in [docs/roadmap.md](docs/roadmap.md) (the
authoritative tracker) — this README stays status-free so it doesn't drift.
